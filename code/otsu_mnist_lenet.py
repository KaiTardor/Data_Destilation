...
if __name__ == '__main__':
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/mnist/example1", "r_mnist_dist1_otsu_ex1")
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/mnist/example2", "r_mnist_dist1_otsu_ex2")
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/mnist/example3", "r_mnist_dist1_otsu_ex3")
    
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/mnist/example1", "r_mnist_dist5_otsu_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/mnist/example2", "r_mnist_dist5_otsu_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/mnist/example3", "r_mnist_dist5_otsu_ex3")
    
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/mnist/example1", "r_mnist_dist01_otsu_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/mnist/example2", "r_mnist_dist01_otsu_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/mnist/example3", "r_mnist_dist01_otsu_ex3")
    
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/fmnist/example1", "fmnist_dist1_otsu_ex1")
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/fmnist/example2", "fmnist_dist1_otsu_ex2")
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/fmnist/example3", "fmnist_dist1_otsu_ex3")
    
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/fmnist/example1", "fmnist_dist5_otsu_ex1")
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/fmnist/example2", "fmnist_dist5_otsu_ex2")
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/fmnist/example3", "fmnist_dist5_otsu_ex3")
    
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/fmnist/example1", "fmnist_dist01_otsu_ex1")
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/fmnist/example2", "fmnist_dist01_otsu_ex2")
    #main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/fmnist/example3", "fmnist_dist01_otsu_ex3")
