...
if __name__ == '__main__':
    ...
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/mnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist1_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/fmnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist1_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/cifar10/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar10_dist1_only_ex1")

    
    print(f"---------------------------------------------------------------------------")
    print("--------------------------MODELOS DISTILLED 005-----------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/mnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist5_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/fmnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist5_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/cifar10/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar10_dist5_only_ex1")
    
    print(f"---------------------------------------------------------------------------")
    print("--------------------------MODELOS DISTILLED 0001----------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/mnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist01_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/fmnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist01_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/cifar10/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar10_dist01_only_ex1")
