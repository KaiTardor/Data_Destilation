...
if __name__ == '__main__':
    ...
    # Ruta de test (puedes cambiar a cifar10 si quieres)
    ...
    for idx, frac in enumerate(fractions, start=1):
        pct = int(frac * 100)
        train_subset = base_train/f"{idx:02d}"/"fashion_mnist"/"stratified"
        #train_subset = base_train/f"{idx:02d}"/"cifar10"/"example1"
        name = f"fmnist_{pct}pct_effnetv2s_ss"
        #name = f"cifar_{pct}pct_effnetv2s_quant"
