...
if __name__ == '__main__':
    ...
    for idx, frac in enumerate(fractions, start=1):
        pct = int(frac * 100)
        #train_subset = base_train/f"{idx:02d}"/"fashion_mnist"/"fps"
        train_subset = base_train/f"{idx:02d}"/"cifar10"/"fps"
        #name = f"fmnist_{pct}pct_effnetv2s_fps_quant"
        name = f"cifar_{pct}pct_effnetv2s_fps"
