...
if __name__ == '__main__':
    ...
    print("--------------------------MODELOS BASE--------------------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/training", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_base")
    main("/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/train", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_base")
    main("/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/train", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar_base")
