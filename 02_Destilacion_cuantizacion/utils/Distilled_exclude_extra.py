...
def main(train_path, test_path, name):
    ...
    dblock = DataBlock(
        ...
        get_items=get_only_distilled_images,
...
if __name__ == '__main__':
    ...
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/mnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist1_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/mnist/example2", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist1_only_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/mnist/example3", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist1_only_ex3")
    ...
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/fmnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist1_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/fmnist/example2", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist1_only_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/fmnist/example3", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist1_only_ex3")
    ...
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/cifar10/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar10_dist1_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/cifar10/example2", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar10_dist1_only_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_01/cifar10/example3", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar10_dist1_only_ex3")

    
    print(f"---------------------------------------------------------------------------")
    print("--------------------------distilld 02-----------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_02/mnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist2_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_02/fmnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist2_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_02/cifar10/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar10_dist2_only_ex3")
    
    
    print(f"---------------------------------------------------------------------------")
    print("--------------------------distilld 04-----------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_04/mnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist4_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_04/fmnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist4_only_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_04/cifar10/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar10_dist4_only_ex3")
