...
if __name__ == '__main__':
    print(f"---------------------------------------------------------------------------")
    print("--------------------------distilld 99 MNIST---------------------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/mnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist99_quant_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/mnist/example2", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist99_quant_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/mnist/example3", "/mnt/homeGPU/haoweihu/code/dataset/original/mnist_png/testing", "mnist_dist99_quant_ex3")
            
    
    print(f"---------------------------------------------------------------------------")
    print("--------------------------distilld 99 fMNIST---------------------------------------")
    print(f"---------------------------------------------------------------------------")      
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/fmnist/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist99_quant_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/fmnist/example2", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist99_quant_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/fmnist/example3", "/mnt/homeGPU/haoweihu/code/dataset/original/fashion_mnist/test", "fmnist_dist99_quant_ex3")

    print(f"---------------------------------------------------------------------------")
    print("--------------------------distilld 99 CIFAR---------------------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/cifar10/example1", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar_dist99_quant_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/cifar10/example2", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar_dist99_quant_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_99/cifar10/example3", "/mnt/homeGPU/haoweihu/code/dataset/original/cifar10/test", "cifar_dist99_quant_ex3")
