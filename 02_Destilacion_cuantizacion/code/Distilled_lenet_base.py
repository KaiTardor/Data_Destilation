...
if __name__ == '__main__':
    ...
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/fmnist/example1", "fmnist_dist1_original_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/fmnist/example2", "fmnist_dist1_original_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_001/fmnist/example3", "fmnist_dist1_original_ex1")
    
    print(f"---------------------------------------------------------------------------")
    print("--------------------------MODELOS DISTILLED 005-----------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/fmnist/example1", "fmnist_dist5_original_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/fmnist/example2", "fmnist_dist5_original_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_005/fmnist/example3", "fmnist_dist5_original_ex3")
    
    print(f"---------------------------------------------------------------------------")
    print("--------------------------MODELOS DISTILLED 0001----------------------------")
    print(f"---------------------------------------------------------------------------")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/fmnist/example1", "fmnist_dist01_quant3_ex1")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/fmnist/example2", "fmnist_dist01_quant3_ex2")
    main("/mnt/homeGPU/haoweihu/code/dataset/distilled_0001/fmnist/example3", "fmnist_dist01_quant3_ex3")
