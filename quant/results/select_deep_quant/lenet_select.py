...
if __name__ == '__main__':
    ...
    for idx, frac in enumerate(fractions, start=1):
        pct = int(frac*100)
        train_subset = base_train/f"{idx:02d}"/"fashion_mnist"/"deep"
        #train_subset = base_train/f"{idx:02d}"/"cifar10"/"deep"
        name = f"fmnist_{pct}pct_deep"
        #name = f"cifar_gray_{pct}pct_deep"
        #name = f"cifar_rgb_{pct}pct_deep_quant"
