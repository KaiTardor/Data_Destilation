...
if __name__ == '__main__':
    ...
    for idx, frac in enumerate(fractions, start=1):
        ...
        for ex in ["example1", "example2"]:
            ...
            train_subset = base_train/f"{idx:02d}"/"cifar10"/ex
            #name = f"fmnist_{pct}pct_{ex}_quant"
            name = f"cifar_gray_{pct}pct_{ex}_quant"
            #name = f"cifar_rgb_{pct}pct_{ex}_quant"
